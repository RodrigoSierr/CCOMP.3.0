...
int main() {
  ...
  for (const Heroe *heroe : heroes) {
    cout << "NOMBRE DEL HÉROE   : " << heroe->obtenerNombre() << endl;
    cout << "TIPO DEL HÉROE     : " << heroe->obtenerTipo() << endl;
    cout << "BIOGRAFÍA DEL HÉROE: " << heroe->obtenerBiografia() << endl;
    cout << endl;

    Estadisticas estadisticas = heroe->obtenerEstadisticas();
    cout << "ESTADÍSTICAS DEL HÉROE:" << endl;
    ...
    cout << "HABILIDADES DEL HÉROE:" << endl;
